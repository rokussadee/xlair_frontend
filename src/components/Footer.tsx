        ...
        <div className="flex-col flex md:flex-row gap-3 transition-all items-center">
            ...
            <div id="instagram-icon-link">
                <a href="https://www.instagram.com/xlairradio" target="_blank">
                    <svg height="24" fill="#ffffffff" viewBox="0 0 32 32" id="Camada_1" version="1.1">
                        <g>
            ...
            <div>
                <a href="mailto:info@xlair.be" target="_blank">
                    ...
                    <path d="M4 7.00005L10.2 11.65C11.2667 12.45 12.7333 12.45 13.8 11.65L20 7" stroke="#ffffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <rect x="3" y="5" width="18" height="14" rx="2" stroke="#ffffffff" stroke-width="1.5" stroke-linecap="round"/>
                    </svg>
                </a>
            </div>
        </div>
